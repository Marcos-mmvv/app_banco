...
if __name__ == '__main__':
    ...
    while True:
        ...
        if opcao == '1':
            ...
            print(f'A conta de {correntista['Nome']} foi criada com sucesso')
            ...
            try:
                ...
                for i in range(len(correntistas)):
                    ...
                    # avança para o próximo loop caso o nome não seja encontrado
                        ...
                        print('Necessário criar uma conta primeiro.')
                        continue
        ...
        # exclui correntista
            ...
            try:
                ...
                print(f'Conta com o ID {indice} encerrada com sucesso.')
            except:
